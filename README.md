...
- **6.1.0-SNAPSHOT** (under development)
  - added --es option to enable spaces between comment chars and directives [#9](https://github.com/raydac/java-comment-preprocessor/issues/9), both in ant and maven versions it is option named `allowSpaceBeforeDirectives`, __NB! by default it is turned off__
