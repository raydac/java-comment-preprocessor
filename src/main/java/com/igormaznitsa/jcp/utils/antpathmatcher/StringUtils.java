...
abstract class StringUtils {
   ...
   *
   * @param str the {@code String} to check (may be {@code null})
   * @return {@code true} if the {@code String} is not {@code null}, its length
  ...
  public static String uriDecode(String source, Charset charset) {
    ...
    Assertions.assertNotNull("Charset must not be null", charset);
   ...
   * returning a new array consisting of the input array contents plus the given
   * {@code String}.
   *
  ...
  /**
   * Convert a comma delimited list (e.g., a row from a CSV file) into an array
   * of strings.
   *
   * @param str the input {@code String}
  ...
  /**
   * Convert a {@code String} array into a comma delimited {@code String} (i.e.,
   * CSV).
   * <p>
   * Useful for {@code toString()} implementations.
   *
